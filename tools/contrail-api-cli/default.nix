...
let
  ...
  self = rec {
    ...
    "datrie" = pythonPackages.buildPythonPackage {
      name = "datrie-0.7.1";
    ...
    "debtcollector" = pythonPackages.buildPythonPackage {
    ...
    "decorator" = pythonPackages.buildPythonPackage {
    ...
    "funcsigs" = pythonPackages.buildPythonPackage {
      name = "funcsigs-1.0.2";
    ...
    "gevent" = pythonPackages.buildPythonPackage {
      name = "gevent-1.2.2";
    ...
    "greenlet" = pythonPackages.buildPythonPackage {
    ...
    "iso8601" = pythonPackages.buildPythonPackage {
      name = "iso8601-0.1.12";
    ...
    "kazoo" = pythonPackages.buildPythonPackage {
      name = "kazoo-2.4.0";
    ...
    "keystoneauth1" = pythonPackages.buildPythonPackage {
    ...
    "msgpack-python" = pythonPackages.buildPythonPackage {
    ...
    "netaddr" = pythonPackages.buildPythonPackage {
      name = "netaddr-0.7.19";
    ...
    "netifaces" = pythonPackages.buildPythonPackage {
    ...
    "networkx" = pythonPackages.buildPythonPackage {
      name = "networkx-2.0";
    ...
    "oslo.config" = pythonPackages.buildPythonPackage {
    ...
    "oslo.i18n" = pythonPackages.buildPythonPackage {
    ...
    "oslo.serialization" = pythonPackages.buildPythonPackage {
    ...
    "oslo.utils" = pythonPackages.buildPythonPackage {
    ...
    "pathlib" = pythonPackages.buildPythonPackage {
      name = "pathlib-1.0.1";
    ...
    "positional" = pythonPackages.buildPythonPackage {
    ...
    "prettytable" = pythonPackages.buildPythonPackage {
    ...
    "prompt-toolkit" = pythonPackages.buildPythonPackage {
    ...
    "pycassa" = pythonPackages.buildPythonPackage {
      name = "pycassa-1.11.2";
    ...
    "pydotplus" = pythonPackages.buildPythonPackage {
    ...
    "python-keystoneclient" = pythonPackages.buildPythonPackage {
    ...
    "rfc3986" = pythonPackages.buildPythonPackage {
      name = "rfc3986-1.1.0";
    ...
    "stevedore" = pythonPackages.buildPythonPackage {
    ...
    "thrift" = pythonPackages.buildPythonPackage {
      name = "thrift-0.9.3";
    ...
    "wrapt" = pythonPackages.buildPythonPackage {
      name = "wrapt-1.10.11";
...
in rec {
  ...
  contrailApiCli = pythonPackages.buildPythonPackage {
    name = "contrail-api-cli-0.2.0";
    src = pkgs.fetchurl {
      url = "https://pypi.python.org/packages/a3/b6/3d78c0aacbf062b2edf3604702edd10b806e6fe1595347e809fa92259d00/contrail-api-cli-0.2.0.tar.gz";
  ...
  contrailApiCliExtra = pythonPackages.buildPythonPackage {
  ...
  contrailApiCliAll = let
    pythonPath = pythonPackages.makePythonPath [
      contrailApiCliExtra
      contrailPkgs.tools.contrailGremlin.python
    ];
  in runCommand "contrail-api-cli-all" {
    nativeBuildInputs = [ makeWrapper ];
  } ''
    makeWrapper ${contrailApiCli}/bin/contrail-api-cli $out/bin/contrail-api-cli \
      --argv0 contrail-api-cli --prefix PYTHONPATH ":" ${pythonPath}
  '';
